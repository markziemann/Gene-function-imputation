...
# gets the common elements of two vectors, a and b
c <- intersect(b,a)
# same result as above
d <- c(unique(a), unique(b))
e <- d[duplicated(d)]
# gets the non common elements in two vectors, a and b
diff.a <- setdiff(a, b)
...
cluster1_GO <- scerevisiae_GO_matrix_wide[scerevisiae_GO_matrix_wide$GeneID %in% rownames(cluster1),] 
cluster1_GO_1 <- scerevisiae_GO_matrix_wide[scerevisiae_GO_matrix_wide$GeneID %in% rownames(cluster1),]
