...
# This function's output is a nested list with all the genes in cluster one and their corresponding correlation values. Inputs:
...
cluster1_wGO <- wcorr2_cluster(is_blind, corr_cluster1, cluster1_GO_terms)
