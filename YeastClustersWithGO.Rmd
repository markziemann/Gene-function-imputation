...
hist(as.numeric(scerevisiae_pass_wide))
...
cluster2 <- clusters[clusters$ClusterNumber == 2,]  
...
### 11. Blinding genes using random strings
...
### 12. Applying Function for K-means results
```{r echo=TRUE}
