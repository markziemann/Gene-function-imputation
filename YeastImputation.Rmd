...
heatmap.2(as.matrix(input_mat), main="S.cerevisiae Cluster 1 GO Terms", scale="none", col = colfunc(25), trace="none", 
          margins = c(5,5))

# create heatmap for imputed df
heatmap.2(as.matrix(imputed_Clust1_df), main="S.cerevisiae Cluster 1 Imputed GO Terms", scale="none", col = colfunc(25), trace="none", 
          margins = c(5,5))

# create heatmap for subtraction matrix
heatmap.2(as.matrix(Clust1_subtract), main="S.cerevisiae Cluster 1 GO Terms vs Imputed GO Terms", scale="none", col = colfunc(25), trace="none", 
          margins = c(5,5))
...
test5 <- impute(GO_allClusters, corr_allClusters, 3, 0.02)

start.time <- Sys.time()
wGO_allClusters <- impute(GO_allClusters, corr_allClusters, 100, 0.02)
end.time <- Sys.time()
