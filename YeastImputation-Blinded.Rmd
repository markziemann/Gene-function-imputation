...
s_agg <- readRDS(file_scaled_PASS)
...
cuttree_values_s <- cl_lengthCut(hr=HR_s[["hr"]], min=1.31, max=4.8, interval=0.001)
saveRDS(cuttree_values_s, "cuttree_values_s.rds")
  
cuttree_values_tmm_pr <- cl_lengthCut(hr=HR_tmm_pr[["hr"]], min=1.2932, max=3.365, interval=0.001)
saveRDS(cuttree_values_tmm_pr, "cuttree_values_tmm_pr.rds")

cuttree_values_tmm_sp <- cl_lengthCut(hr=HR_tmm_sp[["hr"]], min=1.2932, max=3.365, interval=0.001)
saveRDS(cuttree_values_tmm_sp, "cuttree_values_tmm_sp.rds")
...
# Scaled
CS_s <- kfold(cl_list, thresh_list, cuttree_values_s, s_agg, GO_table, GO_blinded)
    saveRDS(CS_s, "CS_s.rds")
    
# TMM Pearson
CS_tmm_pr <- kfold(cl_list, thresh_list, cuttree_values_tmm_pr, logcounts, GO_table, GO_blinded)
    saveRDS(CS_tmm_pr, "CS_tmm_pr.rds")
    
# TMM Spearman
CS_tmm_sp <- kfold(cl_list, thresh_list, cuttree_values_tmm_sp, logcounts, GO_table, GO_blinded)
    saveRDS(CS_tmm_sp, "CS_tmm_sp.rds")
