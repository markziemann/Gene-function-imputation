...
# SandC20_10 <- cross_val(n=10, GO_annot=GO_table, clusters=cluster20,
#                        GO_list_perCl=GO_list_perCl20, 
#                        corr_clAll=corr_allClusters20,
#                        wGO_allClusters=wGO_allClusters20_10,
#                        clust_total=20, thresh=0.1)
# saveRDS(SandC20_10, "SandC20_10.rds")
# 
# 
# 
...
# SandC20_40 <- cross_val(n=10, GO_annot=GO_table, clusters=cluster20,
#                        GO_list_perCl=GO_list_perCl20, 
#                        corr_clAll=corr_allClusters20,
#                        wGO_allClusters=wGO_allClusters20_40,
#                        clust_total=20, thresh=0.4)
# saveRDS(SandC20_40, "SandC20_40.rds")
# 
# 
# 
# start.time <- Sys.time()
...
# 
# SandC20_80 <- cross_val(n=10, GO_annot=GO_table, clusters=cluster20,
#                        GO_list_perCl=GO_list_perCl20, 
#                        corr_clAll=corr_allClusters20,
#                        wGO_allClusters=wGO_allClusters20_80,
#                        clust_total=20, thresh=0.8)
# saveRDS(SandC20_80, "SandC20_80.rds")
# end.time <- Sys.time()
...
SandC50_10 <- cross_val(n=10, GO_annot=GO_table, clusters=cluster50,
                       GO_list_perCl=GO_list_perCl50, 
                       corr_clAll=corr_allClusters50,
                       wGO_allClusters=wGO_allClusters50_10,
                       clust_total=50, thresh=0.1)
saveRDS(SandC50_10, "SandC50_10.rds")


# wGO_allClusters50_40 <- impute(cl_GOall = GOterms_perCl50, 
#                         corr_clAll = corr_allClusters50,
#                         clust_total = 50, thresh = 0.4)
# SandC50_40 <- cross_val(n=10, GO_annot=GO_table, clusters=cluster50,
#                        GO_list_perCl=GO_list_perCl50, 
#                        corr_clAll=corr_allClusters50,
#                        wGO_allClusters=wGO_allClusters50_40,
#                        clust_total=50, thresh=0.4)
# saveRDS(SandC50_40, "SandC50_40.rds")
# 
# start.time <- Sys.time()
...
# 
# SandC50_80 <- cross_val(n=10, GO_annot=GO_table, clusters=cluster50,
#                        GO_list_perCl=GO_list_perCl50, 
#                        corr_clAll=corr_allClusters50,
#                        wGO_allClusters=wGO_allClusters50_80,
#                        clust_total=50, thresh=0.8)
# saveRDS(SandC50_80, "SandC50_80.rds")
# end.time <- Sys.time()
# time.taken <- end.time - start.time
# time.taken
# ---------------------- 
...
# 
# SandC200_10 <- cross_val(n=10, GO_annot=GO_table, clusters=cluster200,
#                        GO_list_perCl=GO_list_perCl200, 
#                        corr_clAll=corr_allClusters200,
#                        wGO_allClusters=wGO_allClusters200_10,
#                        clust_total=200, thresh=0.1)
# saveRDS(SandC200_10, "SandC200_10.rds")
# 
# 
# wGO_allClusters200_40 <- impute(cl_GOall = GOterms_perCl200, 
#                         corr_clAll = corr_allClusters200,
#                         clust_total = 200, thresh = 0.4)
# SandC200_40 <- cross_val(n=10, GO_annot=GO_table, clusters=cluster200,
#                        GO_list_perCl=GO_list_perCl200, 
#                        corr_clAll=corr_allClusters200,
#                        wGO_allClusters=wGO_allClusters200_40,
#                        clust_total=200, thresh=0.4)
# saveRDS(SandC200_40, "SandC200_40.rds")
# 
# start.time <- Sys.time()
...
# 
# SandC200_80 <- cross_val(n=10, GO_annot=GO_table, clusters=cluster200,
#                        GO_list_perCl=GO_list_perCl200, 
#                        corr_clAll=corr_allClusters200,
#                        wGO_allClusters=wGO_allClusters200_80,
#                        clust_total=200, thresh=0.8)
# saveRDS(SandC200_80, "SandC200_80.rds")
# end.time <- Sys.time()
# time.taken <- end.time - start.time
# time.taken
# # ---------------------- 
...
# SandC500_10 <- cross_val(n=10, GO_annot=GO_table, clusters=cluster500,
#                        GO_list_perCl=GO_list_perCl500, 
#                        corr_clAll=corr_allClusters500,
#                        wGO_allClusters=wGO_allClusters500_10,
#                        clust_total=500, thresh=0.1)
# saveRDS(SandC500_10, "SandC500_10.rds")
# 
# 
# wGO_allClusters500_40 <- impute(cl_GOall = GOterms_perCl500, 
#                         corr_clAll = corr_allClusters500,
#                         clust_total = 500, thresh = 0.4)
# SandC500_40 <- cross_val(n=10, GO_annot=GO_table, clusters=cluster500,
#                        GO_list_perCl=GO_list_perCl500, 
#                        corr_clAll=corr_allClusters500,
#                        wGO_allClusters=wGO_allClusters500_40,
#                        clust_total=500, thresh=0.4)
# saveRDS(SandC500_40, "SandC500_40.rds")
# 
# start.time <- Sys.time()
...
# 
# SandC500_80 <- cross_val(n=10, GO_annot=GO_table, clusters=cluster500,
#                        GO_list_perCl=GO_list_perCl500, 
#                        corr_clAll=corr_allClusters500,
#                        wGO_allClusters=wGO_allClusters500_80,
#                        clust_total=500, thresh=0.8)
# saveRDS(SandC500_80, "SandC500_80.rds")
# end.time <- Sys.time()
# time.taken <- end.time - start.time
# time.taken
# # ----------------------
...
# SandC300_10 <- cross_val(n=10, GO_annot=GO_table, clusters=cluster300,
#                        GO_list_perCl=GO_list_perCl300, 
#                        corr_clAll=corr_allClusters300,
#                        wGO_allClusters=wGO_allClusters300_10,
#                        clust_total=300, thresh=0.1)
# saveRDS(SandC300_10, "SandC300_10.rds")
# 
# 
# wGO_allClusters300_40 <- impute(cl_GOall = GOterms_perCl300, 
#                         corr_clAll = corr_allClusters300,
#                         clust_total = 300, thresh = 0.4)
# SandC300_40 <- cross_val(n=10, GO_annot=GO_table, clusters=cluster300,
#                        GO_list_perCl=GO_list_perCl300, 
#                        corr_clAll=corr_allClusters300,
#                        wGO_allClusters=wGO_allClusters300_40,
#                        clust_total=300, thresh=0.4)
# saveRDS(SandC300_40, "SandC300_40.rds")
# 
# start.time <- Sys.time()
...
# 
# SandC300_80 <- cross_val(n=10, GO_annot=GO_table, clusters=cluster300,
#                        GO_list_perCl=GO_list_perCl300, 
#                        corr_clAll=corr_allClusters300,
#                        wGO_allClusters=wGO_allClusters300_80,
#                        clust_total=300, thresh=0.8)
# saveRDS(SandC300_80, "SandC300_80.rds")
# end.time <- Sys.time()
# time.taken <- end.time - start.time
# time.taken
# # ---------------------- 
...
# SandC100_10 <- cross_val(n=10, GO_annot=GO_table, clusters=cluster100,
#                        GO_list_perCl=GO_list_perCl100, 
#                        corr_clAll=corr_allClusters100,
#                        wGO_allClusters=wGO_allClusters100_10,
#                        clust_total=100, thresh=0.1)
# saveRDS(SandC100_10, "SandC100_10.rds")
# 
# 
# wGO_allClusters100_40 <- impute(cl_GOall = GOterms_perCl100, 
#                         corr_clAll = corr_allClusters100,
#                         clust_total = 100, thresh = 0.4)
# SandC100_40 <- cross_val(n=10, GO_annot=GO_table, clusters=cluster100,
#                        GO_list_perCl=GO_list_perCl100, 
#                        corr_clAll=corr_allClusters100,
#                        wGO_allClusters=wGO_allClusters100_40,
#                        clust_total=100, thresh=0.4)
# saveRDS(SandC100_40, "SandC100_40.rds")
# 
# start.time <- Sys.time()
...
# 
# SandC100_80 <- cross_val(n=10, GO_annot=GO_table, clusters=cluster100,
#                        GO_list_perCl=GO_list_perCl100, 
#                        corr_clAll=corr_allClusters100,
#                        wGO_allClusters=wGO_allClusters100_80,
#                        clust_total=100, thresh=0.8)
# saveRDS(SandC100_80, "SandC100_80.rds")
# end.time <- Sys.time()
# time.taken <- end.time - start.time
# time.taken
# # ---------------------- 
...
# SandC1000_10 <- cross_val(n=10, GO_annot=GO_table, clusters=cluster1000,
#                        GO_list_perCl=GO_list_perCl1000, 
#                        corr_clAll=corr_allClusters1000,
#                        wGO_allClusters=wGO_allClusters1000_10,
#                        clust_total=1000, thresh=0.1)
# saveRDS(SandC1000_10, "SandC1000_10.rds")
# 
# start.time <- Sys.time()
# wGO_allClusters1000_40 <- impute(cl_GOall = GOterms_perCl1000, 
#                         corr_clAll = corr_allClusters1000,
#                         clust_total = 1000, thresh = 0.4)
# SandC1000_40 <- cross_val(n=10, GO_annot=GO_table, clusters=cluster1000,
#                        GO_list_perCl=GO_list_perCl1000, 
#                        corr_clAll=corr_allClusters1000,
#                        wGO_allClusters=wGO_allClusters1000_40,
#                        clust_total=1000, thresh=0.4)
# saveRDS(SandC1000_40, "SandC1000_40.rds")
# end.time <- Sys.time()
# time.taken <- end.time - start.time
# time.taken
# 
...
# 
# SandC1000_80 <- cross_val(n=10, GO_annot=GO_table, clusters=cluster1000,
#                        GO_list_perCl=GO_list_perCl1000, 
#                        corr_clAll=corr_allClusters1000,
#                        wGO_allClusters=wGO_allClusters1000_80,
#                        clust_total=1000, thresh=0.8)
# saveRDS(SandC1000_80, "SandC1000_80.rds")
# end.time <- Sys.time()
# time.taken <- end.time - start.time
# time.taken
# 
# SandC1000_90 <- cross_val(n=10, GO_annot=GO_table, clusters=cluster1000,
#                        GO_list_perCl=GO_list_perCl1000, 
#                        corr_clAll=corr_allClusters1000,
#                        wGO_allClusters=wGO_allClusters1000_90,
#                        clust_total=1000, thresh=0.9)
# saveRDS(SandC1000_80, "SandC1000_90.rds")
# 
# SandC1000_100 <- cross_val(n=10, GO_annot=GO_table, clusters=cluster1000,
#                        GO_list_perCl=GO_list_perCl1000, 
#                        corr_clAll=corr_allClusters1000,
#                        wGO_allClusters=wGO_allClusters1000_100,
#                        clust_total=1000, thresh=1)
# saveRDS(SandC1000_80, "SandC1000_100.rds")
# # ---------------------- 
